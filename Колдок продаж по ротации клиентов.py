...
for year in date_list:
    ...
    # print(df2015.sort_values(by=['sum_ship']))
    # Количество клиентов с ротацией по суммам отгрузок
    clients.append(df2015.docs.count())
    clients0.append(df2015.sum_ship[df2015.sum_ship < 30000].count())
    clients30.append(df2015.sum_ship[(df2015.sum_ship < 50000) & (df2015.sum_ship >= 30000)].count())
    clients50.append(df2015.sum_ship[(df2015.sum_ship < 100000) & (df2015.sum_ship >= 50000)].count())
    clients100.append(df2015.sum_ship[(df2015.sum_ship < 300000) & (df2015.sum_ship >= 100000)].count())
    clients300.append(df2015.sum_ship[(df2015.sum_ship < 500000) & (df2015.sum_ship >= 300000)].count())
    clients500.append(df2015.sum_ship[df2015.sum_ship >= 500000].count())
    # clients.append(
    #     sum(clients0) + sum(clients30) + sum(clients50) + sum(clients100) + sum(clients300) + sum(clients500))
